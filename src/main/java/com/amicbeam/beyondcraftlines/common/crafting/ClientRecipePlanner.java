...
public final class ClientRecipePlanner
{
    ...
    public static final class Catalog
    {
        ...
        public Catalog(List<Recipe> recipes)
        {
            ...
            LinkedHashMap<IStackKey<?>, List<Recipe>> index = new LinkedHashMap<>();
            ...
            LinkedHashMap<IStackKey<?>, List<Recipe>> frozen = new LinkedHashMap<>();
            index.forEach((key, value) -> frozen.put(key, List.copyOf(value)));
            this.byOutput = Map.copyOf(frozen);
        }
