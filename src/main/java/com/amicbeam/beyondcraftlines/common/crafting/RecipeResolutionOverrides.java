...
public final class RecipeResolutionOverrides
{
    ...
    public String ingredientFor(ResourceLocation recipe, int slot)
    ...
    public record IngredientChoice(ResourceLocation recipe, int slot, String selection)
    {
        public IngredientChoice(ResourceLocation recipe, int slot, ResourceLocation item)
