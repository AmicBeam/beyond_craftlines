...
final class StructuralRecipeValues
{
                                ...
                                Budget budget, int depth)
    {
        ...
        if (value.getClass().isRecord())
        {
            ...
            // Content-like records conventionally wrap the actual recipe value alongside chance
            // or display metadata. Prefer that component so metadata cannot become a material.
