...
public final class CraftlinesBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<CraftlineDashboardBlockEntity>> CRAFTLINE_DASHBOARD = BLOCK_ENTITIES.register(
            "craftline_dashboard", () -> BlockEntityType.Builder.of(CraftlineDashboardBlockEntity::new,
                    CraftlinesBlocks.CRAFTLINE_DASHBOARD.get()).build(null));
