...
public final class CraftlinesItems {
    ...
    public static final RegistryObject<Item> CRAFTLINE_DASHBOARD = ITEMS.register(
            "craftline_dashboard", () -> new BlockItem(CraftlinesBlocks.CRAFTLINE_DASHBOARD.get(), new Item.Properties()));
