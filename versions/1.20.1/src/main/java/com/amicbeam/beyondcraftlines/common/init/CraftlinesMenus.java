...
public final class CraftlinesMenus {
    ...
    public static final RegistryObject<MenuType<DashboardConfigMenu>> DASHBOARD = MENUS.register("craftline_dashboard", () -> IForgeMenuType.create(DashboardConfigMenu::new));
    public static final RegistryObject<MenuType<DashboardStatusMenu>> DASHBOARD_STATUS = MENUS.register("craftline_dashboard_status", () -> IForgeMenuType.create(DashboardStatusMenu::new));
