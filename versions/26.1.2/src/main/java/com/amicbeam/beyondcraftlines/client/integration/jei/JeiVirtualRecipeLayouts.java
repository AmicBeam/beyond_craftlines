...
public final class JeiVirtualRecipeLayouts
{
    ...
    private static List<Captured> withOutputs(Identifier type, List<KeyAmount> outputs,
    ...
    private static List<Captured> structuredCaptures(Identifier type, Object displayedRecipe)
    {
        ...
        List<OpenOrderMenuPayload.VirtualInput> inputs = RecipeResourceResolver.ingredients(recipe).stream()
                ...
                .toList();
        return withOutputs(type, RecipeOutputResolver.outputs(recipe, level), inputs);
    }
    ...
    {
        public Captured(Identifier type, KeyAmount output, List<OpenOrderMenuPayload.VirtualInput> inputs,
