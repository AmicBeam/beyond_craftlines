...
public final class ClientRecipePreviewTooltip implements ClientTooltipComponent
{
    ...
    @Override
    public void extractImage(Font font, int x, int y, int ignoredWidth, int ignoredHeight,
                             GuiGraphicsExtractor graphics)
    {
        ...
        graphics.centeredText(font, "→", contentX + inputWidth + ARROW_WIDTH / 2,
    ...
    private static void renderSlot(GuiGraphicsExtractor graphics, Font font, KeyAmount stack,
                                   int x, int y, int outline)
    {
        graphics.fill(x, y, x + 18, y + 18, 0xFF111923);
        graphics.outline(x, y, 18, 18, outline);
