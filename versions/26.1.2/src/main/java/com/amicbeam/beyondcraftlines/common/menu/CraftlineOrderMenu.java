...
public final class CraftlineOrderMenu extends AbstractContainerMenu
{
    ...
    public int indexedRecipeCandidates(){return player.level().isClientSide()?com.amicbeam.beyondcraftlines.client.ClientPlanningCatalogWarmup.handle().completedRecipes():0;}
    public int totalRecipeCandidates(){return player.level().isClientSide()?com.amicbeam.beyondcraftlines.client.ClientPlanningCatalogWarmup.handle().totalRecipes():0;}
